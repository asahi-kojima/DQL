import cupy as np
from . import neuralnet_function as nnf
...
class SoftmaxWithLoss:
    ...
    def forward(self, x, t):
        self.t = t
        self.y = nnf.softmax(x)
        self.loss = nnf.cross_entropy_error(self.y, self.t)
...
class Convolution:
    ...
    def forward(self,x):
        ...
        col=nnf.myim2col(x,FH,FW,self.stride,self.pad)
    ...
    def backward(self,dout):
        ...
        dx = nnf.mycol2im(dcol, self.x.shape, FH, FW, self.stride, self.pad)
...
class Pooling:
    ...
    def forward(self,x):
        ...
        col=nnf.myim2col(x,self.pool_h,self.pool_w,self.stride,self.pad)
    ...
    def backward(self,dout):
        ...
        dx=nnf.mycol2im(tmp,self.sheip,self.pool_h,self.pool_w,stride=self.stride,pad=self.pad)
